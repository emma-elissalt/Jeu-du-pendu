# -*- coding: utf-8 -*-
"""
Created on Wed Dec  9 15:55:32 2020

@author: Emma ELISSALT 

statut : finit 
"""
#lien github : https://github.com/emma-elissalt/Jeu-du-pendu 
...
#Fonction qui propose de rejouer au joueur en fin de partie 
#Entrées: event 
def rejouer(event):
    global solution
...
#Fonction qui prend en compte la saisie d'une lettre, qui verifie si elle a déjà été proposée
# qui rempli le mot proposition apres chaque tentative et qui affiche le nombres de tentatives restantes ainsi que les mises à jour des images du pendu  
#en fin de partie il affiche en combien d'echecs le joueur a reussi et sont meilleurs score sur toutes les parties 
def choisirLettre(event):
    ...
    if fTesterLettre(lettre, solution, lettreTrouve): 
        ...
        if not('_' in lProposition):
            ...
            labelTentatives["text"] = "".join("Vous avez gagné avec %d erreurs, votre meilleur score est de %d erreurs." % (nbErreur,meilleurScore))
